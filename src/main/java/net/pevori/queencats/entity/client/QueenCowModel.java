...
public class QueenCowModel extends AnimatedGeoModel<QueenCowEntity> {
    @Override
    public ResourceLocation getModelLocation(QueenCowEntity object) {
    ...
    @Override
    public ResourceLocation getTextureLocation(QueenCowEntity object) {
        return QueenCowRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(QueenCowEntity animatable) {
