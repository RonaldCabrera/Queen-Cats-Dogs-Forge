...
public class PrincessCowModel extends AnimatedGeoModel<PrincessCowEntity> {
    @Override
    public ResourceLocation getModelLocation(PrincessCowEntity object) {
        return new ResourceLocation(QueenCats.MOD_ID, "geo/humanoid_cow_children.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(PrincessCowEntity object) {
        return PrincessCowRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(PrincessCowEntity animatable) {
