...
public class QueenCatEntity extends HumanoidCatEntity implements IAnimatable {
    ...
    private static final EntityDataAccessor<Boolean> SITTING =
            SynchedEntityData.defineId(QueenCatEntity.class, EntityDataSerializers.BOOLEAN);

    private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT =
            SynchedEntityData.defineId(QueenCatEntity.class, EntityDataSerializers.INT);
